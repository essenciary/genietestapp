...
# !!! Main.UserApp is configured as an alias for Main.HelloCloud and you might encounter it in some tests
using Main.HelloCloud, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "HelloCloud tests" begin
  @includetests ARGS
end
